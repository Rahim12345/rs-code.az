      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <form method="POST" action="" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <input type="text" name="slug" class="form-control" id="slug" rows="30">
              ...
              <div class="form-group">
                <input type="text" name="title_az" class="form-control" id="title_az" rows="30">
              ...
              <div class="form-group">
                <input type="text" name="title_ru" class="form-control" id="title_ru" rows="30">
              ...
              <div class="form-group">
                <input type="text" name="title_en" class="form-control" id="title_en" rows="30">
              ...
              <div class="form-group">
                <input type="text" name="review_az" class="form-control" id="review_az">
              ...
              <div class="form-group">
                <input type="text" name="review_en" class="form-control" id="review_en">
              ...
              <div class="form-group">
                <input type="text" name="review_ru" class="form-control" id="review_ru">
              ...
              <div class="form-group">
                <input type="text" name="date_az" class="form-control" id="date_az">
              ...
              <div class="form-group">
                <input type="text" name="date_ru" class="form-control" id="date_ru">
              ...
              <div class="form-group">
                <input type="text" name="date_en" class="form-control" id="date_en">
              ...
              <div class="form-group">
                <textarea name="text_az" class="form-control mg" id="text_az"></textarea>
              ...
              <div class="form-group">
                <textarea name="text_ru" class="form-control mg" id="text_ru"></textarea>
              ...
              <div class="form-group">
                <textarea name="text_en" class="form-control mg" id="text_en"></textarea>
          ...
          <div class="card-footer">
            <button type="submit" class="btn btn-fill btn-primary">Gonder</button>
          </div>
        </form>
        </div>
      </div>
