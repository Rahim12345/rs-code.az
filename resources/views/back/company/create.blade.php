...
@section('content')
    <div class="content m-3">
        <div class="mb-3 col-md-12">
            ...
            <form action="{{ route('company.store') }}" method="POST" enctype="multipart/form-data" class="mb-5">
                @csrf
                <div class="row">
                    ...
                    <div class="form-group mb-3 col-md-4">
                        ...
                        <select name="group_id" id="group_id" class="form-control @error('group_id') is-invalid  @enderror">
                            @foreach($groups as $group)
                                <option value="{{ $group->id }}" {{ old('group_id') == $group->id ? 'selected' : '' }} class="special">{{ $group->name_az }}</option>
                            @endforeach
                        </select>
                        @error('group_id')
                        <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="form-group mb-3 col-md-4">
                        ...
                        <textarea name="about_az" id="about_az" cols="30" rows="4" class="form-control @error('about_az') is-invalid  @enderror">{{ old('about_az') }}</textarea>
                        @error('about_az')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-3 col-md-4">
                        ...
                        <textarea name="about_en" id="about_en" cols="30" rows="4" class="form-control @error('about_en') is-invalid  @enderror">{{ old('about_en') }}</textarea>
                        @error('about_en')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-3 col-md-4">
                        ...
                        <textarea name="about_ru" id="about_ru" cols="30" rows="4" class="form-control @error('about_ru') is-invalid  @enderror">{{ old('about_ru') }}</textarea>
                        @error('about_ru')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
